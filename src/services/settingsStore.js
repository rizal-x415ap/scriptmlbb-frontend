...
const defaultSettings = {
  ...
  // Ad Management & Placements Settings (Desktop & Mobile Separate Slots)
  showHomeSidebarAd1: true,
  homeSidebarAd1Script: '',
  homeSidebarAd1ScriptDesktop: '',
  homeSidebarAd1ScriptMobile: '',
  showHomeSidebarAd2: true,
  homeSidebarAd2Script: '',
  homeSidebarAd2ScriptDesktop: '',
  homeSidebarAd2ScriptMobile: '',
  showHomeFeedAd: true,
  homeFeedAdScript: '',
  homeFeedAdScriptDesktop: '',
  homeFeedAdScriptMobile: '',
  showPreFooterAd: true,
  preFooterAdScript: '',
  preFooterAdScriptDesktop: '',
  preFooterAdScriptMobile: '',
  showArticleMiddleAd: true,
  articleMiddleAdScript: '',
  articleMiddleAdScriptDesktop: '',
  articleMiddleAdScriptMobile: '',
  showArticleEndAd: true,
  articleEndAdScript: '',
  articleEndAdScriptDesktop: '',
  articleEndAdScriptMobile: '',
  showArticleSidebarAd: true,
  articleSidebarAdScript: '',
  articleSidebarAdScriptDesktop: '',
  articleSidebarAdScriptMobile: '',
  // Shortener Page Ad Settings
  showShortenerTopAd: true,
  shortenerTopAdScript: '',
  shortenerTopAdScriptDesktop: '',
  shortenerTopAdScriptMobile: '',
  showShortenerMiddleAd: true,
  shortenerMiddleAdScript: '',
  shortenerMiddleAdScriptDesktop: '',
  shortenerMiddleAdScriptMobile: '',
  showShortenerBottomAd: true,
  shortenerBottomAdScript: '',
  shortenerBottomAdScriptDesktop: '',
  shortenerBottomAdScriptMobile: '',
  showShortenerLeftAd: true,
  shortenerLeftAdScript: '',
  shortenerLeftAdScriptDesktop: '',
  shortenerLeftAdScriptMobile: '',
  showShortenerRightAd: true,
  shortenerRightAdScript: '',
  shortenerRightAdScriptDesktop: '',
  shortenerRightAdScriptMobile: '',
